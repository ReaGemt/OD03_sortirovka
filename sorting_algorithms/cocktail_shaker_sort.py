...
def cocktail_shaker_sort(arr, enable_visualization=True, update_rate=10):
    ...
    while swapped:
        ...
        for i in range(start, end):
            ...
            visualize_sorting(arr, f"Итерация {iteration}: проход слева направо", iteration, update_rate, enable_visualization)
        ...
        for i in range(end - 1, start - 1, -1):
            ...
            visualize_sorting(arr, f"Итерация {iteration}: проход справа налево", iteration, update_rate, enable_visualization)
